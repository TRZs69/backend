...
const ENABLE_UNLIMITED_HISTORY = parseBooleanEnv(
	process.env.LEVELY_CHAT_ENABLE_UNLIMITED_HISTORY,
	false,
);

const MAX_HISTORY_MESSAGES = Number(process.env.LEVELY_CHAT_MAX_HISTORY_MESSAGES || (ENABLE_UNLIMITED_HISTORY ? 1000 : 10));
const MAX_HISTORY_CHARS_PER_MESSAGE = Number(process.env.LEVELY_CHAT_MAX_HISTORY_CHARS || 4000);
const MAX_USER_CONTEXT_COURSES = Number(process.env.LEVELY_CHAT_MAX_USER_COURSES || 8);
const MAX_MATERIAL_CONTEXT_CHARS = Number(process.env.LEVELY_CHAT_MAX_MATERIAL_CONTEXT_CHARS || 12000);
const MAX_ASSESSMENT_CONTEXT_CHARS = Number(process.env.LEVELY_CHAT_MAX_ASSESSMENT_CONTEXT_CHARS || 8000);
const MAX_USER_PROMPT_CHARS = Number(process.env.LEVELY_CHAT_MAX_USER_PROMPT_CHARS || 4000);
const MAX_MATERIAL_IMAGES = Number(process.env.LEVELY_CHAT_MAX_MATERIAL_IMAGES || 5);
const IMAGE_DOWNLOAD_TIMEOUT_MS = Number(process.env.LEVELY_CHAT_IMAGE_DOWNLOAD_TIMEOUT_MS || 2500);
...
const FAST_MAX_OUTPUT_TOKENS = Number(process.env.LEVELY_CHAT_FAST_MAX_OUTPUT_TOKENS || 512);
...
const DETAILED_MAX_OUTPUT_TOKENS = Number(process.env.LEVELY_CHAT_DETAILED_MAX_OUTPUT_TOKENS || 2048);
