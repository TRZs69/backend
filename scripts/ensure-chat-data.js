...
// Mix of casual, straightforward, short, sometimes lowercase/typos
...
// System prompt that matches Levely's actual system prompt
const SYSTEM_PROMPT = [
...
async function ensureChatDataForAllStudents() {
    console.log('[ChatData] Ensuring every student has at least one chat session (LLM generated)...\n');
    ...
    try {
        ...
        for (const student of students) {
            ...
            // Random date within evaluation period (April 8-9 preferred)
        ...
        console.error('[ChatData] Fatal error:', err.message);
